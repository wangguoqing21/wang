...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
      /* {type:'radio'} */
      {field:'cid', width:200,align:'center', title: '序号'}
      ,{field:'cname', width:200,align:'center', title: '名称'}
      ,{field:'price', width:200,align:'center', title: '价格'}
      ,{field:'image', width:200,title:'图片',align:'center', templet:function (d) { return '<div><img src='+d.image+'></div>'}}
      ,{field:'num', width:200, align:'center',title: '剩余数量'}
      ,{
			field : 'pic',
			title : '管理操作',
			width : 200,
