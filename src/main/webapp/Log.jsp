...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
    	...
    	templet : '<div class="layui-btn-group"> <a href="updatelog?gid={{d.id}}" class="layui-table-link"><i class="layui-icon layui-icon-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" lay-event="del" class="layui-table-link"><i class="layui-icon layui-icon-delete"></i></a><div>'}
    ]]
    ,page: true
    , done: function (res) {
